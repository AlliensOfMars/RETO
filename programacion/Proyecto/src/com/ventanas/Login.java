...
/**
     *
     * Evento que se ocupa de la gestion de conexion del trabajador a nuestra
     * base de datos, este llama al metodo filtrarTrabajador, filtrarcentro y
     * log (para hacer la union entre usuario y trabajador y entre trabjador y
     * centro), luego se ocupa de verficar a que categoria pertence el usuario
     * para posteriormente poder enseñarle las ventanas de trabajo
     * correspondientes.
     */
    private void conectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_conectarActionPerformed
        ...
        if (categoria.equalsIgnoreCase("administracion")) {
            ...
            /**
             * Se ocupa de mirar si el usuario tiene algun aviso y si lo tiene
             * lo enseña al usuario, una vez aceptado el aviso este se cambia de
             * estado en la base de datos y nos abre la ventana de cierre de
             * jornada, el aviso se recupera usando el metodo aviso el cual
             * recibe la id del trabajador.
             */
            if (a != null) {
                ...
                /**
                 * Comprobacion que se ocupa de mirar si el trabjador tiene un
                 * parte abierto con fecha distinta a la actual si lo tiene,
                 * este se le abre para que este termine de rellenar los datos y
                 * proceder a su cierre, dicha comprobacion se realiza
                 * comprobando la id del trabajador y la fecha del parte.
                 */
                ...
                this.setVisible(false);
                /**
                 * Comprobacion que se ocupa de verificar si el trabajador ya
                 * tiene un parte con la fecha actual si lo tiene, se procede a
                 * enseñarle la ventana donde insertara los diferentes viajes
                 * que va a realizar en la jornada, dicha comprobacion se
                 * realiza comprobando la id del trabajador y la fecha del
                 * parte.
                 */
             ...
             * Caso todas las anteriores se enseña el panel de logistica, donde
             * el trabajador podra proceder al inicio de jornada.
             */
            else {
